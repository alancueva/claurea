      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative overflow-hidden rounded-lg shadow-sm">
            <Image
              src="https://images.unsplash.com/photo-1747738307140-103b6c352499?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDE1OXw2c01WalRMU2tlUXx8ZW58MHx8fHx8"
